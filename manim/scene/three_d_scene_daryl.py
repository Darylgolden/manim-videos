...
__all__ = ["ThreeDSceneDaryl", "SpecialThreeDSceneDaryl"]
...
class ThreeDSceneDaryl(Scene):
    ...
    def get_riemann_surfaces(self, **kwargs):
        

class SpecialThreeDSceneDaryl(ThreeDSceneDaryl):
